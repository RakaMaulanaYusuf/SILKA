    ...
    <div class="fixed left-0 top-0 h-full transform transition-all duration-300 ease-in-out z-40"
        ...
        <div class="relative h-full bg-white shadow-lg rounded-r-3xl">
            ...
            <nav 
                    ...
                    :class="isOpen 
                        ? 'px-3 max-h-[calc(100vh-250px)]' 
                        : 'px-2 max-h-[calc(100vh-180px)]'"
                >
                <template x-for="(item, index) in [
                    ...
                    {name: 'Kode Akun', route: '/kodeakun', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z'},
                    {name: 'Kode Bantu', route: '/kodebantu', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'},
                    {name: 'Jurnal Umum', route: '/jurnalumum', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'},
                    {name: 'Buku Besar', route: '/bukubesar', icon: 'M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2'},
                    {name: 'Buku Besar Pembantu', route: '/bukubesarpembantu', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'},
                    {name: 'Laba Rugi', route: '/labarugi', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'},
                    {name: 'Neraca', route: '/neraca', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z'}
                ]">
                    <a :href="item.route" 
                        ...
                        <button 
                            ...
                            <div class="flex items-center min-w-0">
                                ...
                                <div class="ml-3 transition-all duration-300 overflow-hidden"
                                    ...
                                    <p class="text-xs font-medium text-black">{{ ucfirst(auth()->user()->nama ?? auth()->user()->role ?? 'Staff') }}</p>
                                </div>
                            </div>
